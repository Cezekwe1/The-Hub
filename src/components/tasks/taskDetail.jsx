...
export default class TaskDetail extends Component{
  ...
  updateOrDisplay = () =>{
    ...
    if (!this.state.updating){
        ...
        actionBtn2 = <button className="" onClick={() => { this.props.deleteTask(this.props.task.id);}} className="btn btn-sm btn-primary mt-5">Discard</button>
        actionBtn3 = ""
        search = "" 
  ...
  render() {
    ...
    return (
      <div className={(this.state.completed == true) ? "card h-auto done mb-5 w-25": "card h-auto normal mb-5 w-25" }>
